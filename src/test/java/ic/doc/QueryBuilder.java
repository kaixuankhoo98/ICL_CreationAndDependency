...
public class QueryBuilder {
    ...
    public QueryBuilder withName1(String name1) {
        this.name1 = name1;
        return this;
    }

    public QueryBuilder withName2(String name2) {
        this.name2 = name2;
        return this;
    }
    ...
    public QueryBuilder withDate1(Integer date1) {
        this.date1 = date1;
        return this;
    }

    public QueryBuilder withDate2(Integer date2) {
        this.date2 = date2;
        return this;
    }
}
